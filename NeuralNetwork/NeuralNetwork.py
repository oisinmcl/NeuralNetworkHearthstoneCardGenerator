...
from Tools.DataTools import Progress
...
class NeuralNetwork:
	...
	def __init__(self):
		...
		self.trainingDataPath = 'NeuralNetwork/training_data'
		...
		self.checkpoint = 'NeuralNetwork/Checkpoints/rnn_train_1524783758-27000000' #4 hours training hearthstone cards
		self.outputDir = 'NeuralNetwork/Output_data'
