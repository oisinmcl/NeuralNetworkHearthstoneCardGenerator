...
from UI.CustomWidgets import HSConfirmPopup, HSFileChooserPopup
...
class CardManager(Screen):
	...
	def __init__(self, **kwargs): 
		super(CardManager, self).__init__(**kwargs)
		...
		self.cardFile = 'NeuralNetwork\Output_data\output_1525082192.txt'
